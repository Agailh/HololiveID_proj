      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl p-8 ">
        ...
        <div className="flex flex-col justify-center md:w-[400px]">
          ...
          <div className="flex justify-start space-x-4">
            <button className="bg-[#43C5F5] hover:bg-[#0db5f2] text-white px-4 py-2 rounded-full">Shop Now</button>
            <button className=" hover:bg-gray-200 text-black px-4 py-2 rounded-full">Get Started</button>
          </div>
        </div>
        <div className="flex justify-center items-center">
